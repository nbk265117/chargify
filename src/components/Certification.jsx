    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            <LogoText>{t('certification.title')}</LogoText>{' '}
            <img
              src="/logo/1xbet.webp"
              alt="1xbet"
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100 transform transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                <h3 className="text-xl font-bold text-gray-900 mb-4 flex items-center">
                  ...
                  {t('certification.verificationTitle')}
                </h3>
                <div className="space-y-3">
                                 <div className="flex items-center space-x-3 rtl:space-x-reverse">
                 <div className="w-2 h-2 bg-primary-600 rounded-full"></div>
                 <p className="text-gray-700">{t('certification.verificationStep1')}</p>
               </div>
                                <div className="flex items-center space-x-3 rtl:space-x-reverse">
                   <div className="w-2 h-2 bg-primary-600 rounded-full"></div>
                   <p className="text-gray-700">{t('certification.verificationStep2')}</p>
                 </div>
               <div className="flex items-center space-x-3 rtl:space-x-reverse">
                 <div className="w-2 h-2 bg-primary-600 rounded-full"></div>
                 <p className="text-gray-700">{t('certification.verificationStep3')}</p>
               </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-r from-primary-50 to-blue-50 rounded-xl p-6 border border-primary-100">
                <h4 className="text-lg font-bold text-gray-900 mb-4 flex items-center">
                  ...
                  {t('certification.needHelp')}
                   ...
                   onClick={() => {
                     const message = t('certification.whatsappMessage')
                 ...
                 >
                   ...
                   <span>{t('certification.whatsappNumber')}</span>
                 </div>
              </div>
