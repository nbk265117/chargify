...
const SimpleTestimonials = () => {
  ...
  useEffect(() => {
    ...
    const element = document.getElementById('simple-testimonials');
    if (element) {
  ...
  return (
    <section id="simple-testimonials" className="py-20 bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-50">
              ...
              <div className="relative z-10 text-center">
                ...
                >
                  <div className="w-24 h-24 mx-auto rounded-full overflow-hidden ring-4 ring-primary-200 shadow-xl">
                    ...
                    <div 
                      className={`w-full h-full flex items-center justify-center text-white font-bold text-2xl bg-gradient-to-br from-primary-500 to-blue-600 ${
