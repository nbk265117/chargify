...
const Promo = () => {
  ...
  return (
    <section id="promo" className="py-20 bg-gradient-to-br from-yellow-50 to-orange-50">
          ...
          <div className="space-y-6">
            {t('promo.features', { returnObjects: true }).map((feature, index) => (
              <div key={index} className={`flex items-center ${isRTL ? 'flex-row-reverse' : ''}`}>
                <div className={`w-8 h-8 bg-yellow-400 rounded-full flex items-center justify-center flex-shrink-0 ${isRTL ? 'ml-4' : 'mr-4'}`}>
